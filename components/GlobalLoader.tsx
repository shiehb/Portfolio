...
export default function GlobalLoader() {
  ...
  useEffect(() => {
    // Don't animate out if we're transitioning
    if (isTransitioning) {
      setMounted(false);
      return;
    }
  ...
  // If transitioning, don't show loader at all
  ...
  return (
    ...
    >
      {/* --- SIMPLE CUSTOMIZABLE LOADER CONTENT --- */}
      <div className="flex flex-col items-center justify-center gap-6 px-4 text-center">
        {/* Custom Logo / Title (Customize here) */}
        ...
        {/* Minimal Progress Bar (Customize width, color, height) */}
        ...
        {/* Counter Number (Customize font/style) */}
